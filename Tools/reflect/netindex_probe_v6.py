...
def main():
    ...
    if off is None:
        ...
        if not expects and not a.probe_package_net and not a.probe_packagemap and not a.probe_package_guids:
            print(
    ...
    if off is None:
        if expects:
            ...
            if off is None:
                return 1
        elif a.probe_package_net or a.probe_packagemap or a.probe_package_guids:
